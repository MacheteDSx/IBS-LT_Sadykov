# 1 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c"
...
# 1 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2
...
# 2 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2
...
# 3 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2
...
# 4 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2

# 1 "BuyTicket.c" 1
BuyTicket()
{

	lr_start_transaction("BuyTicketMain");	
	...
	lr_end_transaction("GotoWebTours",2);
	...
	lr_end_transaction("GotoFlights",2);
	...
	lr_end_transaction("BuyTicketMain",2);	
	
	return 0;
}
# 5 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2

# 1 "BuyTicket3Passengers.c" 1
BuyTicket3Passengers()
{
	...
	lr_end_transaction("FindFlight3Passengers",2);
	...
	lr_end_transaction("SelectFlight3Passengers",2);
	...
	lr_end_transaction("BuyTicket3Passengers",2);
	...
	lr_end_transaction("BuyTicketMain3Passengers",2);	
	
	return 0;
}
# 6 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2
...
# 7 "c:\\users\\machete\\documents\\vugen\\scripts\\uc3_buyticket\\\\combined_UC3_BuyTicket.c" 2
